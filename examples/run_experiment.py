...
def main(config):
    ...
    for t, d, l in zip(config.train_tasks, config.train_datasets, config.loss_functions):
        if not config.eval_only:
            ...
            datasets['train']['metrics'].append(get_metric_computer(cur_dataset.metrics, **cur_dataset.metric_kwargs))
            ...
            datasets['dev']['metrics'].append(get_metric_computer(cur_dataset.metrics, **cur_dataset.metric_kwargs))
            ...
            datasets['test']['metrics'].append(get_metric_computer(cur_dataset.metrics, **cur_dataset.metric_kwargs))
