...
def add_RECCON_span_extraction_annotations(RECCON_span_extraction_data, original_DD_data):
    ...
    for sp_ex in tqdm(RECCON_span_extraction_data):
        ...
        d['dialogue_metadata']['causal_emotion_span_extraction'] = None
...
def add_RECCON_entailment_annotations(RECCON_entailment_data, RECCON_entailment_fields, original_DD_data):
    ...
    for ent_datum in tqdm(RECCON_entailment_data):
        ...
        d['dialogue_metadata']['causal_emotion_entailment'] = None
        DD_ent = {'labels':int(ent_datum[RECCON_entailment_fields.index("labels")])}
